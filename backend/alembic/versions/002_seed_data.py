...
def downgrade() -> None:
    ...
    """)
    op.execute("DELETE FROM accounts WHERE organization_id = '00000000-0000-4000-8000-000000000001'")
    op.execute("DELETE FROM projects WHERE id = '00000000-0000-4000-8000-000000000003'")
    op.execute("DELETE FROM users WHERE id = '00000000-0000-4000-8000-000000000002'")
    op.execute("DELETE FROM organizations WHERE id = '00000000-0000-4000-8000-000000000001'")
